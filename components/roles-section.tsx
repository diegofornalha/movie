  ...
  const roles = [
    {
      title: "Suporte",
      icon: "",
      features: ["Responde dúvidas", "Resolve problemas", "Orienta usuários", "Envia links e instruções"],
      gradient: "from-navy-700 to-navy-900",
    },
    {
      title: "Atendente",
      icon: "",
      features: ["Agenda reuniões", "Envia lembretes", "Coleta informações", "Passa para humano"],
      gradient: "from-navy-600 to-navy-800",
    },
    {
      title: "Vendedor",
      icon: "",
      features: ["Qualifica leads", "Faz ofertas diretas", "Recupera compras", "Fecha vendas"],
      gradient: "from-navy-500 to-navy-700",
    },
    {
      title: "Social Media",
      icon: "",
      features: ["Responde DMs", "Responde comentários", "Gerencia todas as interações", "Atende em segundos"],
              ...
              <div className="bg-gradient-to-br from-dark-800/80 to-dark-900/80 backdrop-blur-sm rounded-2xl p-8 border border-navy-700/30 shadow-xl">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <h3
                      className={`text-3xl font-bold bg-gradient-to-r ${role.gradient} bg-clip-text text-transparent`}
                    >
                      {role.title}
                    </h3>
                  </div>
