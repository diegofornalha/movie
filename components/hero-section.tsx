...
export function HeroSection() {
  return (
    <section
      id="hero-section"
      className="relative py-20 px-4 bg-gradient-to-b from-dark-900 to-dark-800 overflow-hidden"
    >
      {/* Background effects */}
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Funcionários de IA são como ter um "ChatGPT" da sua empresa. Eles entendem e respondem aos clientes,
            executam tarefas e trabalham 24/7 para o seu negócio.
          </p>
          ...
          <div className="pt-8">
            <a
              ...
              className="relative inline-block px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-navy-700 to-navy-900 rounded-full overflow-hidden group transform transition-all hover:scale-105 shadow-lg hover:shadow-navy-700/30 hover:from-navy-600 hover:to-navy-800"
            >
